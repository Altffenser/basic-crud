        ...
        <div class="rounded">
            <div class="flex items-center justify-between p-2">
                <div class="flex flex-col">
                    ...
                    <span class="text-xs font-medium bg-gradient-to-r from-violet-600 to-sky-500 bg-clip-text text-transparent">Desarrollador</span>
                </div>
                <div class="flex items-center justify-center w-10 h-10 bg-gradient-to-r from-violet-600 to-sky-500 text-white rounded-full" data-tooltip-target="tooltip--user-range">
                    @icon($icon)
                </div>
