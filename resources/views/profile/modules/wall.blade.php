<form method="POST" action="{{ route('publications.store', ['published_at' => $user->id, 'user_id' => Auth::user()]) }}" enctype="multipart/form-data">
    @method('POST')
    @csrf
...
<div class="mb-5">
    <h3 class="text-2xl font-bold leading-tight text-black dark:text-white mb-5">Wall and publications</h3>
    {{--        Enlist posts from user--}}
    <ol class="mt-3 divide-y divider-gray-200 dark:divide-gray-700">
        @foreach($user->allPublications($user) as $publication)
            <div class="bg-white w-full rounded-md shadow-md h-auto py-2 px-3 my-5 dark:bg-gray-800 shadow-lg">
